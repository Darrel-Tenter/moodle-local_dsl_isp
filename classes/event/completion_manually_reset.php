...
/**
 * Event fired when a DSP's completion is manually reset.
 *
 * @package    local_dsl_isp
 * @copyright  2026 Direct Support Learning
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class completion_manually_reset extends base {
    ...
    public static function get_name(): string {
        return get_string('eventcompletionmanuallyreset', 'local_dsl_isp');
    }
    ...
    public function get_description(): string {
        $clientid = $this->other['clientid'] ?? $this->objectid;
        $resetby = $this->other['resetby'] ?? $this->userid;

        return "The user with id '{$resetby}' manually reset completion for DSP with id '{$this->relateduserid}' " .
               "on ISP client with id '{$clientid}'.";
    }
