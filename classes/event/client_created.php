 ...
 */
class client_created extends base {
    ...
    public static function get_name(): string {
        return get_string('eventclientcreated', 'local_dsl_isp');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '{$this->userid}' created ISP client '{$clientname}' with id '{$this->objectid}'.";
    }
