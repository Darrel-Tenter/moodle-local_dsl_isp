...
/**
 * Event fired when a DSP is removed from a client.
 *
 * @package    local_dsl_isp
 * @copyright  2026 Direct Support Learning
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dsp_removed extends base {
    ...
    public static function get_name(): string {
        return get_string('eventdspremoved', 'local_dsl_isp');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '{$this->userid}' removed DSP with id '{$this->relateduserid}' " .
               "from ISP client with id '{$clientid}'.";
    }
