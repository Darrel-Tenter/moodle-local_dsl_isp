 ...
 */
class client_updated extends base {
    ...
    public static function get_name(): string {
        return get_string('eventclientupdated', 'local_dsl_isp');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '{$this->userid}' updated ISP client with id '{$this->objectid}'. " .
               "Changed fields: {$fieldnames}.";
    }
