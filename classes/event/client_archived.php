 ...
 */
class client_archived extends base {
    ...
    public static function get_name(): string {
        return get_string('eventclientarchived', 'local_dsl_isp');
    }
    ...
    public function get_description(): string {
        $clientname = $this->other['clientname'] ?? 'Unknown';
        return "The user with id '{$this->userid}' archived ISP client '{$clientname}' with id '{$this->objectid}'.";
    }
